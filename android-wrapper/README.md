...
تتضمن النسخة الحالية تسجيل الدخول برقم الهاتف، إرسال والتحقق من OTP، إنشاء الملف الأساسي، حفظ الجلسة، وتسجيل الخروج. كما أضيفت شاشة العرض الرئيسية، شاشة الخدمات والتخصصات، وقائمة المهنيين مع البحث والتصفية من خلال واجهات الخادم الحقيقية. تم فصل اتصال الشبكة إلى `FazaaApi` و`AuthRepository` و`CatalogRepository`، كما أصبحت حالة المصادقة والكتالوج داخل ViewModels، وأصبح Compose مسؤولًا عن العرض فقط.
